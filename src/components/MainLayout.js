  ...
  return (
    <Layout className='layout'>
      ...
      <Layout className="site-layout">
        <Header 
        className='d-flex justify-content-between ps-3 pe-5 bg-white'
        tyle={{ padding: 0, }}>
          ...
          <div className='d-flex gap-4 align-items-center'>
            ...
            <div className='d-flex gap-3 aling-item-center dropdown' >
              <div>
                <img width={48}
                height={48}
                src="https://lh3.googleusercontent.com/ogw/AAEL6sjFVCjRd99FuB-aama2go_QpzAn_sRdlfc8JWiz1w=s64-c-mo " 
                alt=''/>
              </div>
